...
![建站教程](http://intorice.qiniudn.com/jianzhan.png)
...
![](http://intorice.qiniudn.com/heisencat.png)
...
<br><br>
2,新建一个<abbr title="github上面的项目储存单位"> Repository(仓库)</abbr>
<br>
<small>如图，点击`+ New Repository`</small>
![](http://intorice.qiniudn.com/$}`Q(}T)8K_HL4CADIP4$~9.jpg)
<br>
3,输入相关配置，注意，在网址栏一定要输入`username.github.io`，username指的是你注册时的用户名
<br>
![](http://intorice.qiniudn.com/dhkasdkldsajf.jpg)
<br>
4,新建好后，进入项目，点击右下角`Settings`（设置）
<br>
![](http://intorice.qiniudn.com/fdksahfladf.jpg)
<br>
5,点击 `Automatic page generator`（页面自动生成器）
<br>
![](http://intorice.qiniudn.com/fhalsjkfhka.jpg)
<br>
...
暂时先参考<a href="http://jingyan.baidu.com/article/72ee561ab93d2be16138dfed.html" target="_blank">《mac安装最新版本的git》</a>和<a href="http://git-scm.com/book/en/v2/Getting-Started-Installing-Git
" target="_blank">《安装git》</a>

<br>


1. <p><small>提醒：本文将在2015-01-11更新
2. <p><small>提醒：本文将在2015-01-11更新
3. <p><small>提醒：本文将在2015-01-11更新
...
<dl>
  ...
  <dd><p><b>在代码  gem install jekyll    前加   sudo，在代码后加-V可看到安装详情过程（mac x os）</dd>
<dt><p>解决gem ruby install 很慢的问题</dt>
  <dd><p><b>换成<a href="http://ruby.taobao.org/" target="_blank">淘宝镜像源</a></dd>
  <dt><p>解决报错：Agreeing to the Xcode/iOS license requires admin privileges, please re-run as root via sudo.</dt>
  <dd><p><b>打开 Xcode 会弹出更新说明，点击同意，安装完就可以了</dd>
  <dt><p>测试SSH是否正常工作</dt>
  <dd><p><b>参考<a href="http://www.51cto.com/art/200511/12216.htm
" target="_blank">测试SSH</a></dd>
</dl>
...
- <p>高亮文本使用`{% highlight js %}`、`{% endhighlight %}`
